...
def test_loop(print_mock):
    ...
    print_mock.assert_has_calls(
        [
            mock.call(
                f"pH:     {read_values.tank_controller.ph_probe.get_voltage():>4.5f} pH",
                line=1,
            ),
            mock.call(
    ...
    print_mock.assert_has_calls(
        [
            mock.call(
                f"Temp:   {read_values.tank_controller.temperature_probe_control.get_temperature():>4.3f} C",
                line=1,
            ),
            mock.call(
                f"Res:    {read_values.tank_controller.temperature_probe_control.get_resistance():>4.3f} Ohms",
                line=2,
            ),
            mock.call("", line=3),
