"""
The file to hold the Tank Controller's GUI class
"""
...
class GUI:
    """
    The class for the Tank Controller's GUI
    """

    def __init__(self, tank_controller):
        """
        The GUI for the Tank Controller
        """

        # Keep an Instance of the Tank Controller
        ...
        self.line_1 = tk.Label(
            label_frame,
            text=self.tank_controller.lcd.get_line(1),
            fg=FG,
            bg=BG,
            font=FONT,
            width=WIDTH,
        ...
        self.line_2 = tk.Label(
            label_frame,
            text=self.tank_controller.lcd.get_line(2),
            fg=FG,
            bg=BG,
            font=FONT,
            width=WIDTH,
        ...
        self.line_3 = tk.Label(
            label_frame,
            text=self.tank_controller.lcd.get_line(3),
            fg=FG,
            bg=BG,
            font=FONT,
            width=WIDTH,
        ...
        self.line_4 = tk.Label(
            label_frame,
            text=self.tank_controller.lcd.get_line(4),
            fg=FG,
            bg=BG,
            font=FONT,
            width=WIDTH,
    ...
    def button_press(self, key):
        ...
        """
        self.tank_controller.keypad.set_key(key)
    ...
    def update_lcd(self):
        ...
        while True:
            ...
            self.line_1.config(
                text=self.tank_controller.lcd.get_line(1),
                anchor=self.tank_controller.lcd.get_style(1),
            )
            self.line_2.config(
                text=self.tank_controller.lcd.get_line(2),
                anchor=self.tank_controller.lcd.get_style(2),
            )
            self.line_3.config(
                text=self.tank_controller.lcd.get_line(3),
                anchor=self.tank_controller.lcd.get_style(3),
            )
            self.line_4.config(
                text=self.tank_controller.lcd.get_line(4),
                anchor=self.tank_controller.lcd.get_style(4),
            )
