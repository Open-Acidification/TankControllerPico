...
class UIState:
    ...
    Attributes:
        tank_controller (TankController object): the tank controller is used to move through the state machine
        previous_state (UIState object): the previous_state is used to return the last visited state
        substate (int): the substate is used to keep track of substate of the UIState
    """

    def __init__(self, tank_controller, previous_state=None):
        """
    ...
    def _set_next_state(self, state, update):
        ...
        """
        self.tank_controller.set_next_state(state, update)
