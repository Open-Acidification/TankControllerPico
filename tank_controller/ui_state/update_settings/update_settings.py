...
class UpdateSettings(UIState):
    ...
    def loop(self):
        ...
        """
        if self.substate == 1:
            self.tank_controller.lcd.print("Reset calibration", line=1)
            self.tank_controller.lcd.print("settings to default:", line=2)
            self.tank_controller.lcd.print("(y/n)", line=3)
            self.tank_controller.lcd.print("", line=4)

        elif self.substate == 2:
            self.tank_controller.lcd.print("Default constants", line=1)
            self.tank_controller.lcd.print("restored", line=2)
            self.tank_controller.lcd.print("", line=3)
            self.tank_controller.lcd.print("Any key to continue", line=4)

        elif self.substate == 3:
            self.tank_controller.lcd.print("Set volume in pump:", line=1)
            self.tank_controller.lcd.print("", line=2)
            self.tank_controller.lcd.print("(y/n)", line=3)
            self.tank_controller.lcd.print("", line=4)

        elif self.substate == 4:
            self.tank_controller.lcd.print("Enter Volume in pump", line=1)
            self.tank_controller.lcd.print("", line=2)
            self.tank_controller.lcd.print("", line=3)
            self.tank_controller.lcd.print("Any key to continue", line=4)

        elif self.substate == 5:
            self.tank_controller.lcd.print("Volume in pump set", line=1)
            self.tank_controller.lcd.print("", line=2)
            self.tank_controller.lcd.print("", line=3)
            self.tank_controller.lcd.print("Any key to continue", line=4)
