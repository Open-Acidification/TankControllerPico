...
class UserValue(UIState):
    ...
    def loop(self):
        ...
        """
        self.tank_controller.lcd.print(self.get_label(), line=1)
        self.tank_controller.lcd.print(self.value, style="center", line=2)
        self.tank_controller.lcd.print("*=. A)ccept B)ack", line=3, style="center")
        self.tank_controller.lcd.print("D)ecline  C)lear", line=4, style="center")
