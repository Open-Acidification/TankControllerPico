...
class ResetThermalCalibration(UIState):
    """
    ...
    def __init__(self, titrator, previous_state=None):
        """
        Initialize the ResetThermalCalibration state
    ...
    def loop(self):
        """
        Main loop for the ResetThermalCalibration state
        """
        pass

    def handle_key(self, key):
        """
        Handle key input for the ResetThermalCalibration state
        """
